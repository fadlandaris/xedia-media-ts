...
const Navbar = () => {
  ...
  return (
    <nav className="px-10 flex justify-between right-0 left-0 py-4 md:px-16 items-center font-bold fixed z-30 text-[12px]   bg-gradient-to-b from-black/40 via-black/30 to-none backdrop-blur-sm  ">
